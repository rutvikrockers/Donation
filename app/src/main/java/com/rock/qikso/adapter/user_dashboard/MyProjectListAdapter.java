...
import com.rock.qikso.model.Project;
...
public class MyProjectListAdapter extends RecyclerView.Adapter<MyProjectListAdapter.ViewHolder> {
    ...
    private MyProjectList myProjectList;
    private Context mContext;


    public MyProjectListAdapter(List<Project> projectsData, FragmentActivity activity, MyProjectList myProjectList) {
    ...
    @Override
    public void onBindViewHolder(MyProjectListAdapter.ViewHolder holder, final int position) {
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            amountRaised = (TextView) mView.findViewById(R.id.comment);
