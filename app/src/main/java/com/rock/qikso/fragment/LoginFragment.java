            ...
            call.enqueue(new retrofit2.Callback<ResponseUserLogin>() {
                ...
                public void onFailure(Call<ResponseUserLogin> call, Throwable t) {
                  t.printStackTrace();
                    ...
                    Utils.showAlert(getActivity(), call.toString());
                }
            });
